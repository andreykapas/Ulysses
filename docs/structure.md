...
- Секция **Loki** и правила для ИИ-помощников — см. [AGENTS.md](../AGENTS.md) (без спойлеров входа в этом файле).
...
Ullis — порт приписки для всего флота (тексты, песни, видео, книги),
